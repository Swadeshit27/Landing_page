...
const Description: React.FC<props> = ({ imgSrc, title, details, className, isRevers = false }) => {
    return (
        <section className='w-full h-auto py-6 md:py-8 max-w-screen-xl mx-auto px-4 sm:px-8 grid sm:grid-cols-2 gap-x-8 lg:gap-x-16 place-items-center'>
            ...
            <div className='max-sm:order-2'>
                <h1 className='text-xl lg:text-2xl font-semibold text-gray-950 mb-2.5 lg:mb-4'>{title}</h1>
